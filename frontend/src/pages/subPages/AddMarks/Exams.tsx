...
import type { examType } from "../ViewMark/teacher/TeacherExam";
import { useFetchStudentsByClass } from "../../../hooks/useStudentData";
import toast from "react-hot-toast";
import Spinner from "../../../components/Spinner";
import { useAddExamMarks } from "../../../hooks/useMarkData";
import {
  AlertCircle,
  BookOpen,
  Calendar,
...
export const Exams = () => {
  ...
  const { mutate: postExamMarksData, isPending: submitting } =
    useAddExamMarks();
  ...
  const handleSubmit = () => {
    if (!selectedSubject || !examDate || !examType) {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 sm:mb-12 animate-fadeIn text-center">
          ...
          <p className="text-slate-400 text-base sm:text-lg max-w-2xl mx-auto">
            Enter student marks for exam marks with ease
          </p>
        </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-2">
              ...
              >
                {["FA-1", "FA-2", "FA-3", "FA-4", "SA-1", "SA-2"].map(
                  (x, idx) => (
        ...
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-slate-800/90 border border-cyan-500/30 rounded-2xl p-8 flex flex-col items-center gap-4 shadow-2xl">
            ...
            <p className="text-slate-400 text-sm text-center">
              Saving {marks.length} student records for {examType}
            </p>
          </div>
        </div>
      )}
