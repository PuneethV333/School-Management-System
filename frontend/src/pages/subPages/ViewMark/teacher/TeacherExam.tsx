...
import { getGrade, resolveExamDataForTeacher } from "../../../../utils/resolveUtDataForTeachers";
import SelectClass from "../../../../components/SelectClass";
import SelectSubjectType from "../../../../components/SelectSubject";
import { AlertCircle, Award, BarChart3, BookOpen, TrendingUp } from "lucide-react";
...
const TeacherExam = () => {
  ...
  >("english");
    ...
    const [examType, setExamType] = useState<examType>("FA-1");
    const {data:studentsData,isPending:loadingExamData} = useFetchExamMarks(classNo,userData)
    ...
    if (loading || loadingExamData) return <Spinner />;
      ...
      const Controls = () => (
        <div className="sticky top-0 z-10 backdrop-blur-md bg-slate-950/80 border-b border-slate-800/60">
          <div className="max-w-5xl mx-auto px-6 py-3 flex flex-wrap items-center gap-3">
            ...
            <SelectExamType dataType={examType} setDataType={setExamType} />
      ...
      const res = resolveExamDataForTeacher(studentsData, subject, examType);
  ...
  return (
    <div className="min-h-screen bg-slate-950 mt-10">
      <Controls />
        ...
        {!hasAnyMarks && res.length > 0 && (
          <div className="rounded-2xl border border-amber-800/30 bg-amber-950/20 px-6 py-5 flex items-center gap-3">
            ...
            <p className="text-sm text-amber-300/80">
              ...
              <span className="uppercase">{examType}</span> haven't been entered
              yet.
            </p>
          </div>
        )}
