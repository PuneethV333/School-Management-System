...
interface SelectClassProps {
  dataType: examType;
  setDataType: React.Dispatch<React.SetStateAction<examType>>;
}

const SelectExamType: React.FC<SelectClassProps> = ({
  dataType,
  setDataType,
}) => {
  const types = ["FA-1", "FA-2", "FA-3", "FA-4", "SA-1", "SA-2"] as const;
