...
interface SelectClassProps {
  dataType: 'kannada'|'hindi'|'social'|'science'|'maths'|'math'|'mathematics'|'english';
  setDataType: React.Dispatch<
    React.SetStateAction<'kannada'|'hindi'|'social'|'science'|'maths'|'math'|'mathematics'|'english'>
  >;
}

const SelectSubjectType: React.FC<SelectClassProps> = ({ dataType, setDataType }) => {
  const types = ['kannada','hindi','social','science','maths','english'] as const;
