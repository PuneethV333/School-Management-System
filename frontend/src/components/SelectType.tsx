...
interface SelectClassProps {
  dataType: "monthly" | "weekly";
  setDataType: React.Dispatch<React.SetStateAction<"monthly" | "weekly">>;
}

const SelectType: React.FC<SelectClassProps> = ({ dataType, setDataType }) => {
  const types = ["monthly", "weekly"] as const;
